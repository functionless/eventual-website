...
In the next part, [eventualCloud Part 2 - Features](./2023-04-04-eventualCloud-Part-1-Philosophy.mdx), we'll walk through each of the features offered by Eventual. Be sure to check that out if you want to see some code!
