...
Each Service can be thought of as exposing a Service Contract, consisting of APIs and Events, and then internal business logic implemented with Workflows, Activities and Subscriptions.
...
import devCycle from "./dev-cycle.png";
