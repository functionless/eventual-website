...
To get set up, follow the [Quick Start](../quick-start.mdx) guide so that you have a fresh project to work with.
...
:::tip
For more information on why we re-export everything from the `index.ts`, see the [End-to-End Types and Schemas](../concepts/end-to-end-safety.md) documentation.
:::
...
:::info
See the [HttpError](../reference/api/command.md#httperror) documentation.
:::
...
:::info
See the [Async Activity](../reference/orchestration/activity.md#async-activity) documentation.
:::
