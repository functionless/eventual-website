...
<div className="row">
  <Card
    ...
    description="A collection of composable APIs, Events, Workflows, and Tasks for orchestrating a business domain."
  />
  <Card
    name="⚙️ Workflow"
  ...
  <Card
    ...
    description="Emit and subscribe Events to and from your Service. Process events internally or route them to other Services."
  />

  <Card
    name="🔌 Task"
    url="reference/orchestration/task"
