...
- Exploring the project template for your chosen infrastructure-as-code (IaC) platform: [AWS Cloud Development Kit (CDK)](./supported-frameworks/aws-cdk.md) or [AWS SST](./supported-frameworks/aws-sst.md).
